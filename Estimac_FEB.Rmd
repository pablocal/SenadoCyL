...
cis <- foreign::read.spss("data/3240.sav", to.data.frame = T )
```
...
# sit_eco
frq(cis$sit_eco)
cis$sit_eco_mala <- recode(cis$sit_eco, "Mala" = 1, "Muy mala" = 1, "Regular" = 2, "Buena" = 3, "Muy buena" = 3, .default = 2)
...
cis$sit_eco_pers_mala <- recode(cis$sit_eco_pers, "Mala" = 1, "Muy mala" = 1, "Regular" = 2, "Buena" = 3, "Muy buena" = 3, .default = 2)
...
# sit_pol
frq(cis$sit_pol)
cis$sit_pol_mala <- recode(cis$sit_pol, "Mala" = 1, "Muy mala" = 1, "Regular" = 2, "Buena" = 3, "Muy buena" = 3, .default = 2)
...
# valora_gob
frq(cis$valora_gob)
cis$valora_gob_mala <- recode(cis$valora_gob, "Mala" = 1, "Muy mala" = 1, "Regular" = 2, "Buena" = 3, "Muy buena" = 3, .default = 2)
...
frq(cis$recuerdo)
levels(cis$recuerdo)
cis$rec <- recode(cis$recuerdo, "PP" = "PP", 
                       "PSOE" = "PSOE", 
                       "Unidos Podemos" = "UP", "En Comú Podem" = "UP", "En Marea" = "UP",  "Compromís-Podemos-EUPV" = "UP",
                       "C's" = "Cs",
                       "ERC" = "ERC",
                       "EAJ-PNV" = "PNV",
                       "EH Bildu" = "Bildu",
                       "CC-PNC" = "CC",
                       "CDC" = "PdeCat",
                       "Voto nulo" = "NuloBlanco",
                       "En blanco" = "NuloBlanco",
                       "No votó" = "Abstenc",
                       "No tenía edad" = "Abstenc" ,
                       "No tenía derecho a voto" = "Abstenc", 
                       "No recuerda" = NA_character_, 
                       "N.C." = NA_character_, 
                       .default = "Otros")

table(cis$recuerdo, cis$rec)
